  ...
  return (
    <div className='bg-[#121212] h-14 rounded-lg grid grid-cols-3 items-center px-2 sm:px-4 w-full select-none shrink-0'>
      ...
      <div className='flex items-center justify-end gap-2 sm:gap-3'>
        ...
        <div className='w-9 h-9 rounded-full bg-[#282828] hover:scale-105 transition cursor-pointer flex items-center justify-center font-bold text-xs border border-[#3e3e3e] text-white uppercase shrink-0'>
          U
        </div>
      </div>
